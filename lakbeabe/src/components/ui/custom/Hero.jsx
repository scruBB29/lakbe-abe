...
function Hero() {
  return (
    <div className='flex flex-col items-center justify-center h-screen mx-56 gap-9'>
      <h1 className='font-extrabold text-[50px] text-center'>
        <span className='text-[#000000]'>Discover Your Next Adventure with AI: </span>Personalized Itineraries at Your Fingertips
      </h1>
